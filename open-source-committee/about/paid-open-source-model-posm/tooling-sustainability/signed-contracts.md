...
Below are copies of the signed Contracts and relevant Milestone Acceptance Forms recevied by the Open Source Committee.&#x20;
...
{% file src="../../../.gitbook/assets/Mellod_Design_Services_Agreement_Cicerium_PRDMS-_OSC-0015-26_(1).pdf" %}
...
**Milestone 1:** Meet with the Civics committee and necessary\
working groups under Civics. Go over current tool\
capabilities and create a delta of work to meet the specific\
needs of the committee.

{% file src="../../../.gitbook/assets/Milestone Acceptance Form Cicerium PRDMS M1.docx.pdf" %}
...
{% file src="../../../.gitbook/assets/PRDMS Milestone 2 MAF.pdf" %}

**Milestone 3:** Production deployment of tool. Monitor the tool for the initial usage (Cardano Constitution Amendment Process).

{% file src="../../../.gitbook/assets/Milestone Acceptance Form - Milestone 3 PRDMS.pdf" %}
